...
/****************** PRINT POINTER ******************/
/**
 * print_all_pointer - Prints the value of a pointer variable
...
/************************* PRINT NON PRINTABLE *************************/
/**
 * print_all_non_printable - Prints ascii codes in hexa of non printable chars
...
/************************* PRINT REVERSE *************************/
/**
 * print_all_reverse - Prints reverse string.
 * @types: Lista of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width

...
/****************** PRINT POINTER ******************/
/**
 * print_all_pointer - Prints the value of pointer variable
 * @types: Listof arg
...
/************************* PRINT NON PRINTABLE *************************/
/**
 * print_all_non_printable - Prints ascii codes in hexa of non printable characterss
 * @types: List of arg
 * @buffer: Buffer array to be handle print
 * @flags:  Calculates the active flags
 * @width: get a width
 * @precision: Precision a  specification
 * @size: Size specifier
...
/************************* PRINT REVERSE *************************/
/**
 * print_all_reverse - Prints a reverse string.
 * @types: List of arg
 * @buffer: Buffer array to be handle print
 * @flags:  Calculates a active flags
 * @width: get a width
...
/**
 * print_rot13 string - Print string in rot13.
 * @types: List of arg
 * @buffer: Buffer array to be handle print
 * @flags:  Calculates a active flags
 * @width: get a width
